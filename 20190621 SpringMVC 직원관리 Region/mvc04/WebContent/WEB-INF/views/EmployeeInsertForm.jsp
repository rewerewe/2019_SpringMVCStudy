...
<!-----------------------------------------------------------------------
	#14. EmployeeInsertForm.jsp
	- 직원 데이터 입력 페이지
	- 관리자가 접근하는 직원 데이터 입력 페이지
 ------------------------------------------------------------------------>
		...
		<form action="employeeinsert.action" method="post" id="employeeForm">
			<table>
				...
				<tr>
					<th>주민번호</th>
					<td>
						<input type="text" id="ssn1" name="ssn1" maxlength="6"  style="width: 100px;" placeholder="앞자리">-
						<input type="password" id="ssn2" name="ssn2" maxlength="7" style="width: 110px;" placeholder="뒷자리">
					</td>
				</tr>
				<tr>
					<th>생년월일</th>
