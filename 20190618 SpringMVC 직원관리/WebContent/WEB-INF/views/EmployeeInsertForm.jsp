		...
		<form action="employeeinsert.action" method="post" id="employeeForm">
			<table>
				...
				<tr>
					<th>주민번호</th>
					<td>
						<input type="text" id="ssn1" name="ssn1" style="width: 100px;" placeholder="앞자리">-
						<input type="password" id="ssn2" name="ssn1" style="width: 110px;" placeholder="뒷자리">
					</td>
				</tr>
				<tr>
					<th>생년월일</th>
				...
				<tr>
					...
					<button type="button" class="btn" id="listBtn" style="width: 40%">직원 리스트</button>
					<br><br>
